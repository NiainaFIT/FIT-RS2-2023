...
using eProdaja.Infrastructure.Entities;

namespace eProdaja.Infrastructure.Database;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-GE4D4SV;Initial Catalog=eProdaja; user=sa; password=test; TrustServerCertificate=true");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<IzlazStavke>(entity =>
        {
            ...
            entity.HasOne(d => d.Izlaz).WithMany(p => p.IzlazStavke)
                .HasForeignKey(d => d.IzlazId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_IzlazStavke_Izlazi");

            entity.HasOne(d => d.Proizvod).WithMany(p => p.IzlazStavke)
        ...
        modelBuilder.Entity<Izlazi>(entity =>
        {
            ...
            entity.HasOne(d => d.Korisnik).WithMany(p => p.Izlazi)
                .HasForeignKey(d => d.KorisnikId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Izlazi_Korisnici");

            entity.HasOne(d => d.Narudzba).WithMany(p => p.Izlazi)
                .HasForeignKey(d => d.NarudzbaId)
                .HasConstraintName("FK_Izlazi_Narudzbe");

            entity.HasOne(d => d.Skladiste).WithMany(p => p.Izlazi)
        ...
        modelBuilder.Entity<NarudzbaStavke>(entity =>
        {
            ...
            entity.HasOne(d => d.Narudzba).WithMany(p => p.NarudzbaStavke)
                .HasForeignKey(d => d.NarudzbaId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_NarudzbaStavke_Narudzbe");

            entity.HasOne(d => d.Proizvod).WithMany(p => p.NarudzbaStavke)
                .HasForeignKey(d => d.ProizvodId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Narudzbe>(entity =>
        {
            ...
            entity.HasOne(d => d.Kupac).WithMany(p => p.Narudzbe)
        ...
        modelBuilder.Entity<Ocjene>(entity =>
        {
            ...
            entity.HasOne(d => d.Kupac).WithMany(p => p.Ocjene)
                .HasForeignKey(d => d.KupacId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Ocjene_Kupci");

            entity.HasOne(d => d.Proizvod).WithMany(p => p.Ocjene)
                .HasForeignKey(d => d.ProizvodId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Proizvodi>(entity =>
        {
            ...
            entity.HasOne(d => d.JedinicaMjere).WithMany(p => p.Proizvodi)
                .HasForeignKey(d => d.JedinicaMjereId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Proizvodi_JediniceMjere");

            entity.HasOne(d => d.Vrsta).WithMany(p => p.Proizvodi)
        ...
        modelBuilder.Entity<UlazStavke>(entity =>
        {
            ...
            entity.HasOne(d => d.Proizvod).WithMany(p => p.UlazStavke)
                .HasForeignKey(d => d.ProizvodId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_UlazStavke_Proizvodi");

            entity.HasOne(d => d.Ulaz).WithMany(p => p.UlazStavke)
        ...
        modelBuilder.Entity<Ulazi>(entity =>
        {
            ...
            entity.HasOne(d => d.Dobavljac).WithMany(p => p.Ulazi)
                .HasForeignKey(d => d.DobavljacId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Ulazi_Dobavljaci");

            entity.HasOne(d => d.Korisnik).WithMany(p => p.Ulazi)
                .HasForeignKey(d => d.KorisnikId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Ulazi_Korisnici");

            entity.HasOne(d => d.Skladiste).WithMany(p => p.Ulazi)
                .HasForeignKey(d => d.SkladisteId)
                .OnDelete(DeleteBehavior.ClientSetNull)
